...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200/80 pb-6">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight uppercase">
            Vehicle IQ Media Processing Engine
          </h1>
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            disabled={refreshing}
            className="flex items-center space-x-2 px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold shadow-sm transition-all duration-200"
          >
            <RefreshCw className={`w-3.5 h-3.5 ${refreshing ? 'animate-spin text-orange-400' : 'text-slate-300'}`} />
            <span>Refresh Engine</span>
          </button>
          <Link
            href="/upload"
            className="btn-orange flex items-center space-x-2 px-5 py-2.5 text-white font-bold text-xs shadow-md"
          >
      ...
      {/* Metrics 3D Cards Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="card-3d p-5 border-l-4 border-l-slate-900 bg-white">
          <div className="flex justify-between items-start">
            ...
            <div className="w-10 h-10 bg-slate-900 text-white flex items-center justify-center shadow-sm">
        ...
        <div className="card-3d p-5 border-l-4 border-l-amber-500 bg-white">
          <div className="flex justify-between items-start">
            <div>
            ...
            <div className="w-10 h-10 bg-amber-900 text-amber-100 flex items-center justify-center shadow-sm">
        ...
        <div className="card-3d p-5 border-l-4 border-l-emerald-600 bg-white">
          <div className="flex justify-between items-start">
            <div>
            ...
            <div className="w-10 h-10 bg-emerald-900 text-emerald-100 flex items-center justify-center shadow-sm">
        ...
        <div className="card-3d p-5 border-l-4 border-l-rose-600 bg-white">
          <div className="flex justify-between items-start">
            <div>
            ...
            <div className="w-10 h-10 bg-rose-900 text-rose-100 flex items-center justify-center shadow-sm">
